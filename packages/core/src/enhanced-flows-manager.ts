...
/**
 * Enhanced FlowsManager that inherits from BaseConfigManager
 * Provides standardized data normalization and audit capabilities
 */
export class EnhancedFlowsManager extends BaseConfigManager<DirectusFlow> {
